...
export function getCuratedNews(ticker: string, startYear: number = 2023, endYear: number = 2024): NewsItem[] {
  ...
  const allNews: Array<{
    ...
    // MSFT & GOOGL & TLT & QQQ News
    {
      id: "news-2023-01-23-msft-openai",
      headline: "Microsoft announces multi-billion dollar investment in OpenAI to commercialize ChatGPT",
      summary: "Microsoft broadens partnership with OpenAI to integrate foundation models into Azure and Microsoft 365 Copilot.",
      source: "benzinga",
      symbols: ["MSFT", "QQQ"],
      publishedAt: "2023-01-23T14:00:00Z",
    },
    {
      id: "news-2023-02-08-googl-bard",
      headline: "Alphabet showcases Bard conversational AI and search integration in Paris event",
      summary: "Google introduces Gemini predecessor capabilities and AI summaries across core search engine.",
      source: "benzinga",
      symbols: ["GOOGL", "QQQ"],
      publishedAt: "2023-02-08T15:30:00Z",
    },
    {
      id: "news-2023-07-25-msft-googl-q2",
      headline: "Microsoft and Alphabet beat earnings expectations driven by cloud and digital advertising resilience",
      summary: "Azure cloud growth stabilizes at 26% while Google Cloud maintains profitability.",
      source: "benzinga",
      symbols: ["MSFT", "GOOGL", "QQQ", "SPY"],
      publishedAt: "2023-07-25T20:30:00Z",
    },
    {
      id: "news-2023-10-19-tlt-10yr-yield",
      headline: "10-year US Treasury yield breaches 5.0% for first time since 2007 as bond sell-off accelerates",
      summary: "Persistent inflation fears and heavy Treasury issuance push long-term sovereign bond yields to 16-year highs.",
      source: "benzinga",
      symbols: ["TLT", "SPY"],
      publishedAt: "2023-10-19T14:30:00Z",
    },
    {
      id: "news-2024-01-30-msft-azure-ai",
      headline: "Microsoft Q2 FY24 results demonstrate accelerating Azure revenue growth fueled by enterprise AI demand",
      summary: "AI services contribute 6 percentage points of growth to Azure as enterprise deployment scales.",
      source: "benzinga",
      symbols: ["MSFT", "QQQ"],
      publishedAt: "2024-01-30T21:30:00Z",
    },
    {
      id: "news-2024-04-25-googl-dividend",
      headline: "Alphabet announces first-ever cash dividend and $70 billion share repurchase program on stellar Q1",
      summary: "Google beats across Search, YouTube, and Cloud while initiating quarterly dividend of $0.20 per share.",
      source: "benzinga",
      symbols: ["GOOGL", "QQQ", "SPY"],
      publishedAt: "2024-04-25T20:30:00Z",
    },
    {
      id: "news-2024-09-18-tlt-fed-rally",
      headline: "Treasury bond ETF (TLT) surges following aggressive 50bps Federal Reserve interest rate cut",
      summary: "Long-duration bonds gain as bond market prices in lower terminal rate path.",
      source: "benzinga",
      symbols: ["TLT", "SPY"],
      publishedAt: "2024-09-18T19:30:00Z",
    },
  ];
    ...
    MSFT: [
      {
        ...
        filedAt: "2023-04-26T18:00:00.000Z",
        revenue: 52857000000,
        grossProfit: 36720000000,
        operatingIncome: 22352000000,
        netIncome: 18299000000,
        eps: 2.45,
        totalAssets: 380088000000,
        totalLiabilities: 185415000000,
        stockholdersEquity: 194673000000,
        currentAssets: 163889000000,
        currentLiabilities: 89088000000,
        cashAndEquivalents: 104427000000,
        totalDebt: 59578000000,
        operatingCashFlow: 24373000000,
        capitalExpenditures: 6607000000,
        freeCashFlow: 17766000000,
        grossMargin: 0.6947,
        operatingMargin: 0.4229,
        netMargin: 0.3462,
        debtToEquity: 0.306,
        currentRatio: 1.8396,
        revenueGrowthYoY: 0.0708,
      },
      {
        id: "msft-10k-2023-fy",
        symbol: "MSFT",
        ...
        fiscalPeriod: "FY",
        periodEndDate: "2023-06-30",
        filedAt: "2023-07-27T18:00:00.000Z",
        revenue: 56189000000,
        grossProfit: 39394000000,
        operatingIncome: 24291000000,
        ...
        cashAndEquivalents: 111262000000,
        totalDebt: 59965000000,
        operatingCashFlow: 28773000000,
        capitalExpenditures: 8943000000,
        freeCashFlow: 19830000000,
        grossMargin: 0.7011,
        operatingMargin: 0.4323,
        netMargin: 0.3574,
        debtToEquity: 0.2908,
        currentRatio: 1.7692,
        revenueGrowthYoY: 0.0834,
      },
      {
        id: "msft-10q-2024-q2",
        symbol: "MSFT",
        ...
        fiscalPeriod: "Q2",
        periodEndDate: "2023-12-31",
        filedAt: "2024-01-31T18:00:00.000Z",
        revenue: 62020000000,
        grossProfit: 42433000000,
        operatingIncome: 27032000000,
        netIncome: 21870000000,
        eps: 2.93,
        totalAssets: 470558000000,
        totalLiabilities: 232263000000,
        stockholdersEquity: 238295000000,
        currentAssets: 172900000000,
        currentLiabilities: 110500000000,
        cashAndEquivalents: 81000000000,
        totalDebt: 75000000000,
        operatingCashFlow: 18900000000,
        capitalExpenditures: 9700000000,
        freeCashFlow: 9200000000,
        grossMargin: 0.6842,
        operatingMargin: 0.4359,
        netMargin: 0.3526,
        debtToEquity: 0.3147,
        currentRatio: 1.5647,
        revenueGrowthYoY: 0.1758,
      },
    ],
    GOOGL: [
      {
        id: "googl-10q-2023-q1",
        symbol: "GOOGL",
        cik: "0001652044",
        form: "10-Q",
        fiscalYear: 2023,
        ...
        filedAt: "2023-04-26T18:00:00.000Z",
        revenue: 69787000000,
        grossProfit: 39682000000,
        operatingIncome: 17415000000,
        netIncome: 15051000000,
        eps: 1.17,
        totalAssets: 369491000000,
        totalLiabilities: 109265000000,
        stockholdersEquity: 260226000000,
        currentAssets: 162985000000,
        currentLiabilities: 69300000000,
        cashAndEquivalents: 115102000000,
        totalDebt: 29500000000,
        operatingCashFlow: 21720000000,
        capitalExpenditures: 6289000000,
        freeCashFlow: 15431000000,
        grossMargin: 0.5686,
        operatingMargin: 0.2495,
        netMargin: 0.2157,
        debtToEquity: 0.1134,
        currentRatio: 2.3519,
        revenueGrowthYoY: 0.0261,
      },
      {
        id: "googl-10q-2024-q1",
        symbol: "GOOGL",
        cik: "0001652044",
        form: "10-Q",
        fiscalYear: 2024,
        ...
        filedAt: "2024-04-26T18:00:00.000Z",
        revenue: 80539000000,
        grossProfit: 47000000000,
        operatingIncome: 25472000000,
        netIncome: 23662000000,
        eps: 1.89,
        totalAssets: 407399000000,
        totalLiabilities: 117282000000,
        stockholdersEquity: 290117000000,
        currentAssets: 179240000000,
        currentLiabilities: 75200000000,
        cashAndEquivalents: 108000000000,
        totalDebt: 28400000000,
        operatingCashFlow: 28848000000,
        capitalExpenditures: 12012000000,
        freeCashFlow: 16836000000,
        grossMargin: 0.5836,
        operatingMargin: 0.3163,
        netMargin: 0.2938,
        debtToEquity: 0.0979,
        currentRatio: 2.3835,
        revenueGrowthYoY: 0.1541,
      },
    ],
    TLT: [
      {
        ...
        fiscalPeriod: "Q2",
        periodEndDate: "2023-04-30",
        filedAt: "2023-06-23T18:00:00.000Z",
        revenue: 850000000,
    ...
    QQQ: [
      {
        ...
        fiscalPeriod: "FY",
        periodEndDate: "2023-09-30",
        filedAt: "2023-11-20T18:00:00.000Z",
        revenue: 12500000000,
        grossProfit: 12500000000,
        operatingIncome: 12350000000,
        netIncome: 12350000000,
        eps: null,
        totalAssets: 205000000000,
        totalLiabilities: 800000000,
        stockholdersEquity: 204200000000,
        currentAssets: 205000000000,
        currentLiabilities: 800000000,
        cashAndEquivalents: 900000000,
        totalDebt: 0,
        operatingCashFlow: 12200000000,
        capitalExpenditures: 0,
        freeCashFlow: 12200000000,
        grossMargin: 1.0,
        operatingMargin: 0.988,
        netMargin: 0.988,
        debtToEquity: 0.0039,
        currentRatio: 256.25,
