...
Compatible with any coding agent that supports skills. For agents that read from `.agents/skills/` (like Antigravity) or `.claude/skills/` (like Claude Code and OpenCode), just drop it in and go.
